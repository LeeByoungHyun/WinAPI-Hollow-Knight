...
namespace ya
{
	...
	void MantisLord1::Update()
	{
		...
		switch (mState)
		{
		case ya::MantisLord1::eMantisLordsState::Idle:
			idle();
			break;

		case ya::MantisLord1::eMantisLordsState::ThroneIdle:
			throneIdle();
			break;

		case ya::MantisLord1::eMantisLordsState::ThroneStand:
			throneStand();
			break;

		case ya::MantisLord1::eMantisLordsState::ThroneBow:
			throneBow();
			break;

		case ya::MantisLord1::eMantisLordsState::ThroneLeave:
			throneLeave();
			break;

		case ya::MantisLord1::eMantisLordsState::ThroneWounded:
			throneWounded();
			break;

		case ya::MantisLord1::eMantisLordsState::Gesture1:
			gesture1();
			break;

		case ya::MantisLord1::eMantisLordsState::Gesture2:
			gesture2();
			break;

		case ya::MantisLord1::eMantisLordsState::DashArrive:
			dashArrive();
			break;

		case ya::MantisLord1::eMantisLordsState::DashAnticipate:
			dashAnticipate();
			break;

		case ya::MantisLord1::eMantisLordsState::Dash:
			dash();
			break;

		case ya::MantisLord1::eMantisLordsState::DashRecover:
			dashRecover();
			break;

		case ya::MantisLord1::eMantisLordsState::DashLeave:
			dashLeave();
			break;

		case ya::MantisLord1::eMantisLordsState::DstabArrive:
			dStabArrive();
			break;

		case ya::MantisLord1::eMantisLordsState::Dstab:
			dStab();
			break;

		case ya::MantisLord1::eMantisLordsState::DstabLand:
			dStabLand();
			break;

		case ya::MantisLord1::eMantisLordsState::DstabLeave:
			dStabLeave();
			break;

		case ya::MantisLord1::eMantisLordsState::WallArrive:
			wallArrive();
			break;

		case ya::MantisLord1::eMantisLordsState::WallReady:
			wallReady();
			break;

		case ya::MantisLord1::eMantisLordsState::WallLeave1:
			wallLeave1();
			break;

		case ya::MantisLord1::eMantisLordsState::WallLeave2:
			wallLeave2();
			break;

		case ya::MantisLord1::eMantisLordsState::Throw:
			wallThrow();
			break;
	...
	void MantisLord1::Render(HDC hdc)
	{
		GameObject::Render(hdc);
	}

	void MantisLord1::Release()
	{
		GameObject::Release();
	}
	...
	void MantisLord1::OnCollisionExit(Collider* other)
	{
		GameObject::OnCollisionExit(other);
	}

	void MantisLord1::Reset()
	{
	...
	void MantisLord1::dashAnticipate()
	{
