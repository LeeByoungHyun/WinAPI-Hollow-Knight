...
namespace ya
{
	...
	void Block_Large::Initialize()
	{
		tr = AddComponent<Transform>();
		mImage = ResourceManager::Load<Image>(L"Block_BG", L"..\\Resources\\GodHome\\Block_BG.bmp");

		mCollider = AddComponent<Collider>();
		mCollider->SetSize(Vector2(2640.0f, 1144.0f));
		mCollider->SetCenter(Vector2(-1320.0f, -1144.0f));

		GameObject::Initialize();
	}

	void Block_Large::Update()
	{
		GameObject::Update();
	}

	void Block_Large::Render(HDC hdc)
	{
	...
	void Block_Large::Release()
	{
		GameObject::Release();
	}

	void Block_Large::OnCollisionEnter(Collider* other)
	{

	}

	void Block_Large::OnCollisionStay(Collider* other)
	{
	...
	void Block_Large::OnCollisionExit(Collider* other)
	{
		eLayerType otherType = other->GetOwner()->GetType();
		if (otherType == eLayerType::Player)
		{
