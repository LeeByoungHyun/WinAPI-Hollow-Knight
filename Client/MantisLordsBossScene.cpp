...
namespace ya
{
	...
	void MantisLordsBossScene::Initialize()
	{
		...
		object::Instantiate<MantisLords>(Vector2(800.0f, 300.0f), eLayerType::Monster);
		object::Instantiate<MantisLords>(Vector2(500.0f, 300.0f), eLayerType::Monster);
		object::Instantiate<MantisLords>(Vector2(1100.0f, 300.0f), eLayerType::Monster);
	}
