...
namespace ya
{
	...
	void Platform02::Update()
	{
		GameObject::Update();
	}

	void Platform02::Render(HDC hdc)
	{
	...
	void Platform02::Release()
	{
		GameObject::Release();
	}

	void Platform02::OnCollisionEnter(Collider* other)
	{
		
	}

	void Platform02::OnCollisionStay(Collider* other)
	{
	...
	void Platform02::OnCollisionExit(Collider* other)
	{
		eLayerType otherType = other->GetOwner()->GetType();
		if (otherType == eLayerType::Player)
		{
