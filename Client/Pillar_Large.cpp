...
namespace ya
{
	...
	void Pillar_Large::Initialize()
	{
		tr = AddComponent<Transform>();
		mImage = ResourceManager::Load<Image>(L"Pillar_Large", L"..\\Resources\\GodHome\\Pillar_Large.bmp");

		mCollider = AddComponent<Collider>();
		mCollider->SetSize(Vector2(289.0f, 2234.0f));
		mCollider->SetCenter(Vector2(-144.5f, -2234.0f));

		GameObject::Initialize();
	}

	void Pillar_Large::Update()
	{
		GameObject::Update();
	}

	void Pillar_Large::Render(HDC hdc)
	{
	...
	void Pillar_Large::Release()
	{
		GameObject::Release();
	}

	void Pillar_Large::OnCollisionEnter(Collider* other)
	{

	}

	void Pillar_Large::OnCollisionStay(Collider* other)
	{
	...
	void Pillar_Large::OnCollisionExit(Collider* other)
	{
		eLayerType otherType = other->GetOwner()->GetType();
		if (otherType == eLayerType::Player)
		{
